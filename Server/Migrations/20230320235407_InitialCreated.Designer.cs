...
namespace Bienes.Server.Migrations
{
    ...
    [Migration("20230320235407_InitialCreated")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bienes.Server.Models.Cliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bienes.Server.Models.Terreno", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bienes.Server.Models.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bienes.Server.Models.UsuarioRol", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bienes.Server.Models.Usuario", b =>
                {
                    b.HasOne("Bienes.Server.Models.UsuarioRol", "UsuarioRol")
                        .WithMany()
